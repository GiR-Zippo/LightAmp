            ...
            while (!token.IsCancellationRequested)
            {
                while (_messageQueue.TryDequeue(out var message))
                    try
                    {
                        ...
                        {
                            case 48:
                                _packet.Size48(timeStamp, otherActorId, myActorId, message); //[7.15]Handles Ensemble Clear
                                break;
                            case 56:
                                _packet.Size56(timeStamp, otherActorId, myActorId, message); //[7.15]Handles Ensemble Request, Ensemble Reject, and Instrument Equip/De-Equip.
                                break;
                            case 88:
                                _packet.Size88(timeStamp, otherActorId, myActorId, message); //[7.15]Handles EnsembleStart --DALAMUD
                                break;
                            case 104:
                                _packet.Size104(timeStamp, otherActorId, myActorId, message); //[7.15]Handles Party Invite
                                break;
                            case 664:
                            ...
                            case 688:
                                ...
                                break;
                            case 1064:
                                _packet.Size1064(timeStamp, otherActorId, myActorId, message); //[7.15]Handles Ensemble play data
                                break;
                            case 3576:
                                _packet.Size3576(timeStamp, otherActorId, myActorId, message);
                                break;
                            case 3704:
                                _packet.Size3704(timeStamp, otherActorId, myActorId, message); //[7.15]Handles group data
                                break;
                            default:
